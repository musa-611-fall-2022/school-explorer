 ...
 * @LastEditTime: 2022-10-19 23:43:49
...
function ShowShoolsList(schoolsToShow, schoolList) {
    schoolList.innerHTML = '';

for (const school of schoolsToShow) {
    const html = `
    <li class="school-list-item">${school['name']} (Grades: ${school['Current Grade Span Served']})</li>
    `;
